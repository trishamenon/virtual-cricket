...
void Game::welcome() {
	...
	cout << "--------------- Cric-In ---------------" << endl;
	cout << "Welcome to this Virtual Cricket Game" << endl;
	cout << "Instructions:" << endl;
	cout << " " <<endl;
	cout << "1. Create 2 teams (Team-A and Team-B, with 4 players each) from the given pool of 11 players" << endl;
	cout << "2. Lead the toss and decide whether batting or bowling" << endl;
	...
	for (int i = 0; i < playersPerTeam; i++) {
		...
		teamASelection:
			...
			if (playerIndexTeamA < 0 || playerIndexTeamA > 10) {
				cout << endl << "Please select from the given choice of players " <<endl;

				goto teamASelection;
			} else if (!validateSelectedPlayer(playerIndexTeamA)) {
				cout << endl << "This player has already been selected. Select another player" << endl;
		...
		teamBSelection:
			...
			if (playerIndexTeamB < 0 || playerIndexTeamB > 10) {
					...
					cout << endl << "Player has already been selected. Select another player" << endl;
...
void Game::startFirstInnings() {
	...
	cout << "\t\t FIRST INNINGS BEGINS! " << endl << endl;
...
void Game::startSecondInnings() {
	...
	cout << "\t\t SECOND INNINGS BEGINS! " << endl << endl;
...
void Game::showMatchSummary() {
	...
	cout << "\t\t THE MATCH IS OVER! " << endl << endl;
